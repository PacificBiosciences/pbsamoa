...
public:
    ...
    explicit BamRawReader(BamCollection collection, BamRawReaderConfig config = {});
    explicit BamRawReader(std::vector<std::filesystem::path> paths, BamRawReaderConfig config = {});
    explicit BamRawReader(std::vector<BamFile> files, BamRawReaderConfig config = {});
