...
inline const TagKey RG_TAG{'R', 'G'};
...
constexpr char TagKey::First() const { return static_cast<char>((value_ >> 8) & 0xFFU); }

constexpr char TagKey::Second() const { return static_cast<char>(value_ & 0xFFU); }
